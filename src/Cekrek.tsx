...
export default function Cekrek() {
  ...
  const baseUrl = "https://cekrekening-api.belibayar.online/api/v1/account-inquiry";
        ...
        <div className="form-control mt-10 mb-5">
          ...
          >
            <option value="" selected disabled>
              ...
              <option value="nusantara_parahyangan">Bank Nusantara Parahyangan</option>
              ...
              <option value="sumsel_dan_babel_syr">Bank Sumsel Babel Syariah</option>
              ...
              <option value="victoria_internasional">Bank Victoria International</option>
